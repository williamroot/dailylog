...
Detalhamento: de 2016 a 2018; recorte temporal por dia útil; 100 trajetos
...
WITH ano_2018 as (
  ...
  FROM `tvg-bd-governo.mobilidade_sp_prd.view_uber_horadodia`
  WHERE Recorte = 'diasuteis'
    AND ano = 2018
